export const archetypes = {
  visionary: {
    ...
    description: 'You see the future before it arrives. Not as fantasy\u2014as architecture. You articulate the destination that pulls a movement forward, the moral horizon that makes the present intolerable and the future feel not just possible but inevitable. Your power is the power of imagination disciplined by conviction: you do not merely dream of a better world, you describe it with enough specificity and moral force that other people begin to organize their lives around making it real.',
  ...
  strategist: {
    ...
    description: 'You are the chess player of the movement. While others respond to the crisis in front of them, you are mapping the board three moves ahead\u2014analyzing where power sits, identifying the pressure points where intervention will have the greatest leverage, and designing the sequence of actions that connects today\'s organizing to next year\'s victory. Your mind works in systems: you do not see a legislative fight\u2014you see the committee structure, the vote count, the media cycle, the coalition dynamics, and the twelve points of intervention where strategic pressure can shift the outcome.',
  ...
  analyst: {
    ...
    description: 'You are the intellectual engine of the movement. You research, you framework, you diagnose. You produce the analytical infrastructure that movements build on\u2014turning lived experience into theory, theory into tools, and tools into the shared language that allows diverse communities to understand their common conditions and coordinate their responses. Where the Visionary sees the destination and the Strategist designs the route, the Analyst maps the terrain itself.',
  ...
  bridgeBuilder: {
    ...
    description: 'You create unlikely alliances. You move fluently between communities, sectors, and political cultures that rarely speak to one another, and you build the bridges that allow them to act together. Where others see irreconcilable differences, you see shared interests waiting to be articulated. Your power is relational: you read rooms, you remember names, you track relationships across time and organizations, and you invest in trust before it is strategically necessary\u2014because you understand that trust cannot be manufactured at the moment you need it.',
  ...
  healer: {
    ...
    description: 'You center care, restoration, and sustainability in spaces that are structured around urgency, sacrifice, and perpetual crisis. You are the one who notices when a colleague has been running on fumes for three months, who insists the meeting include a check-in before diving into strategy, who holds space for grief, for rage, for exhaustion, and for the quiet human moments that keep people connected to the reasons they started this work in the first place. In movements that celebrate self-sacrifice and valorize burnout, your insistence on sustainability is itself a form of resistance.',
  ...
  diplomat: {
    ...
    description: 'You work the inside game. While others march outside the halls of power, you move through them\u2014building relationships with decision-makers, negotiating concessions, navigating bureaucracies, and securing the incremental gains that accumulate into structural change. You stay at the table not because you are comfortable with power but because you understand that the table is where many of the decisions that affect communities\' lives are actually made, and absence from it is not purity\u2014it is forfeiture.',
  ...
  organizer: {
    ...
    description: 'You build the base. Everything else in a movement\u2014the strategy, the narrative, the legal arguments, the policy demands\u2014depends on there being an organized constituency of people ready to act collectively. You are the person who builds that constituency: one door, one conversation, one relationship, one commitment at a time, until an entire community is ready to move together. Your power is not charisma\u2014it is methodology. You know how to identify potential leaders, develop their skills, and build the structures that transform individual grievances into collective power.',
  ...
  agitator: {
    ...
    description: 'You raise the heat. You are the one who is willing to be disliked, to force uncomfortable confrontations, to create the crisis that makes the status quo more costly than change. You name what others will not name. You disrupt what others have agreed to tolerate. You refuse the polite fiction that systems of oppression will reform themselves if asked nicely enough, and you create the conditions under which those with power must respond to those without it.',
  ...
  storyteller: {
    ...
    description: 'You transform lived experience into narrative power. You make the invisible visible. You change what people feel before trying to change what they think\u2014because you understand that in a democracy saturated with information, the battle for hearts precedes and enables the battle for policy. Your medium may be testimony, a social media campaign, a documentary, a sermon, or a conversation over coffee. The medium matters less than the capacity: you take the raw material of human experience and shape it into narratives that move people to act.',
  ...
  architect: {
    ...
    description: 'You build the structures that outlast campaigns. While others fight today\'s battle, you are designing the policy frameworks, legal architectures, and institutional systems that will determine the terrain on which tomorrow\'s battles are fought. You think in decades. You design systems that encode justice into structure\u2014so that the next generation inherits not just values but the institutional machinery to enforce them. Your mind works at the intersection of law, policy, and institutional design.',
  ...
  operator: {
    ...
    orientationWeight: { insideOutside: 0, righteousnessRelationship: 0 },
    motivationBonus: ['policy', 'community', 'service'],
    description: 'You run the machine. You are the person who turns strategy into logistics, vision into budgets, and ambition into operational plans with timelines, deliverables, and accountability structures. Movements celebrate their visionaries and orators. They rarely celebrate the person who built the donor database, negotiated the venue contract, managed the budget through a crisis, or figured out the transportation logistics that got three thousand people to the state capitol on a Tuesday morning. That person is you\u2014and you know that the most brilliant strategy in the world is worthless without someone who can execute it.',
  ...
  guardian: {
    ...
    description: 'You provide direct support and mutual aid to community members in crisis. You are the front line of solidarity\u2014the person who shows up with food when someone is evicted, who staffs the know-your-rights training, who runs the mutual aid distribution point, who builds the peer-to-peer, non-hierarchical systems of care and protection that keep communities alive while the longer-term fights are waged. You operate on a fundamental truth: people who are hungry, unhoused, or unsafe cannot wait for the policy change or the next election. They need help now.',
